...
class ColoredTracking:
	...
	def __init__(self, buffer=16):
		...
		rospy.logwarn("[Robot2] ColoredTracking node [ONLINE]")
	...
	def cbShowImage(self):
		...
		cv2.imshow("[Robot2] Color Detector", self.cv_image)
		cv2.waitKey(1)
	...
	def cbShutdown(self):
		try:
			rospy.logwarn("[Robot2] ColoredTracking node [OFFLINE]")
		finally:
...
if __name__ == '__main__':
	...
	rospy.init_node('colored_tracking_robot2', anonymous=False)
